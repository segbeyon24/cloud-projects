...
SES_SENDER_EMAIL = os.environ.get('SES_SENDER_EMAIL', 'kuneheponebene@gmail.com')
SES_RECIPIENT_EMAIL = os.environ.get('SES_RECIPIENT_EMAIL', 'segbeyonebene@gmail.com')
SNS_TOPIC_ARN = 'arn:aws:sns:us-east-1:519171483739:receiptTexts'
...
def send_email_notification(receipt_data):
    ...
    sns.publish(
            ...
            Subject="Receipt in Text",
            Message=json.dumps({"data": receipt_data}, indent=2)
    )
